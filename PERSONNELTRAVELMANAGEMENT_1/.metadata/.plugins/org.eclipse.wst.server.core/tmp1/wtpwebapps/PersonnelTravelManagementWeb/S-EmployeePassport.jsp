...
<head>
<meta charset="utf-8">
<title>DataBuilder-Passport</title>
...
<body class=" ">
	...
	<div id="page-container">
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body collapse in">
									<form class="form-horizontal" action="EmployeePassport" method="POST">
										<input type="hidden"  name="forms" id="forms" value="addPassport" />
										...
										<div class="form-group ">
											 <label for="focusedinput" class="col-sm-2 control-label datepicker">Expiration Date:</label>
			                  				  <div class="col-sm-3">
			                                    <div class="input-group date datepicker2">
			                                        <input type="text" class="form-control" id="expirationdate" name="expirationdate" placeholder="YYYY-MM-DD" required/>
								...
								<div class="panel-body collapse in">
									<div class="table-responsive">
										<table
											...
											<tbody>
												<c:forEach items="${passlist}" var="acc">
													<tr>
														<td>${acc.employee}</td>
														<td>${acc.department}</td>
														<td>${acc.passportno}</td>
														<td>${acc.expirydate}</td>
														<td>
														<c:choose>
														...
														<td><a data-toggle="modal"
															data-passid="${acc.passportid}" href="#myModal"
															class="btn btn-info btn-xs editPassport">
		...
		<%@include file="modal/_EmployeePassport.jsp"%>
	</div>
	<!-- page-container -->
