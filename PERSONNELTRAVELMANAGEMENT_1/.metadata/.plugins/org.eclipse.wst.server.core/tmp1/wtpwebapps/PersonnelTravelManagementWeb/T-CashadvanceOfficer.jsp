...
<!--BEGIN ADD FORM-->
		<div class="row">
			<div class="col-md-12">
				<a href="#" class="btn btn-success margBelow approveCA" data-status="7"><i class="glyphicon glyphicon-check"></i> Approve</a>
				<a href="#" class="btn btn-danger margBelow margLeft cancelCA" data-status="8"><i class="glyphicon glyphicon-remove-circle"></i> Not Approve</a>
	...
	<%@include file="modal/_CashAdvanceComment.jsp"%>
</div> <!-- page-container -->
...
<script type='text/javascript' src='assets/js/CA_Status.js'></script>
