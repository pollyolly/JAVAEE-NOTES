                        ...
                        <div class="col-md-4 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-success" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center">${expapp[0].count}</div>
                        ...
                        <div class="col-md-4 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center">${expnot[0].count}</div>
...
<!-- END DASH ITEMS -->
			<div class="row">
                    <div class="col-md-6 col-lg-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>My Expense Analytical Report - <%= new java.text.SimpleDateFormat("yyyy").format(new java.util.Date()) %></h4>
                                <div class="options">   
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h4>My Travel Analytical Report - <%= new java.text.SimpleDateFormat("yyyy").format(new java.util.Date()) %></h4>
                                <div class="options">   
                                    <!--a href="javascript:;"><i class="fa fa-cog"></i></a-->
                                    <a href="javascript:;" class="panel-collapse"><i class="fa fa-chevron-down"></i></a>
                                </div>
