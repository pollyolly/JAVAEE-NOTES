...
<head>
    <meta charset="utf-8">
    <title>ConfigurationManagement-Company Policy</title>
...
<div id="page-content">
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body collapse in">
                        ...
                        <input type="hidden" class="form-control" name="forms" id="forms" value="addPolicy" />
					<div class="form-group ">
                            <label for="focusedinput" class="col-sm-2 control-label">Expense Age(days):</label>
                            <div class="col-sm-3">
                              <input type="number" class="form-control" id="expensedays" name="expensedays" placeholder="0">
                            </div>
                          </div>
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input class="form-control" type="number" id="receiptamount" name="receiptamount">
								<span class="input-group-addon">.00</span>
							</div>
						</div>
					</div>
                        <div class="form-group">
						<label class="col-sm-2 control-label">Max Expense:</label>
						<div class="col-sm-3">
							<div class="input-group">
								<input class="form-control" type="number" id="maxexpense" name="maxexpense">
								<span class="input-group-addon">.00</span>
							</div>
						</div>
					</div>
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input class="form-control" type="number" id="maxbudget" name="maxbudget">
								<span class="input-group-addon">.00</span>
							</div>
						</div>
						</div>
                        ...
                        <div class="panel-body collapse in">
                           <div class="table-responsive">
                            <table class="table table-striped table-bordered  table-hover datatables dataTable" id="DataTables_Table_0">
                                <thead>
                                    <tr>
                                    <th>Expense Age(days)</th>
                                    <th>Receipt Amounnt</th>
                                    <th>Max Expense</th>
									<th>Max Budget</th>
                                    <th>Status</th>
                                    <th>Action</th>
                            ...
                            <c:forEach items="${policylist}" var="policy">
                                    <tr><td>${policy.expensedays}</td>
                                        <td><fmt:formatNumber value="${policy.receiptamount}" type="number" minFractionDigits="2"/></td>
                                        <td><fmt:formatNumber value="${policy.maxexpense}" type="number" minFractionDigits="2"/></td>
										<td><fmt:formatNumber value="${policy.maxbudget}" type="number" minFractionDigits="2"/></td>
                                        <td><c:choose>
										<c:when test="${policy.status == 'Active'}">
											<span class="label label-success">Active</span>
										</c:when>
										<c:when test="${policy.status == 'Pending'}">
                                        ...
                                        <td>
                                            <a href="#myModal" data-toggle="modal" data-editpolicyid="${policy.policyid}" class="btn btn-info btn-xs editPolicy"><li class="fa fa-edit"></li></a>                 
                                        </td>
                                    </tr>
                              </c:forEach>
                            </tbody>
	...
	<%@include file="modal/_CompanyPolicy.jsp"%>
</div> <!-- page-container -->
