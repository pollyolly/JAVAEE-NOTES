...
<head>
<meta charset="utf-8">
<title>ConfigurationManagement-User Management</title>
...
<body class=" ">
	...
	<div id="page-container">
							...
							<div class="panel panel-primary">
								...
								<div class="panel-body collapse in">
									<form class="form-horizontal" action="UserManagement" method="POST">
										<input type="hidden"  name="forms" id="forms" value="addAccount" />
										...
										<div class="form-group ">
											...
											<div class="col-sm-3">
												<input type="text" class="form-control" id="username"
													name="username" placeholder="Maximum 16 Characters">
											</div>
										</div>
										<div class="form-group ">
											...
											<div class="col-sm-3">
												<input type="password" class="form-control" id="password"
													name="password" placeholder="Maximum 16 Characters">
											</div>
										</div>
										<div class="form-group ">
											<label for="mediuminput" class="col-sm-2 control-label">Role:</label>
											<div class="col-sm-3">
												...
												<c:forEach items="${accList}" var="acc">
													<tr>
														...
														<td><a data-toggle="modal"
															data-editaccid="${acc.accountid}" href="#myModal"
															class="btn btn-info btn-xs editAcc">
		...
		<%@include file="modal/_Usermanagement.jsp"%>
	</div>
	<!-- page-container -->
