...
<head>
	<meta charset="utf-8">
	<title>Data-Builder-Service Provider</title>
...
<!--BEGIN ADD FORM-->
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body collapse in">
                        <form class="form-horizontal" action="ServiceProvider" method="POST">
                          ...
                          <input type="hidden" id="forms" name="forms" value="addSP">
                            <label for="focusedinput" class="col-sm-2 control-label">Company:</label>
                            <div class="col-sm-3">
                              <input type="text" class="form-control" id="company" name="company" placeholder="Name" required>
                            </div>
                          </div>
					<div class="form-group ">
					...
					<div class="form-group ">
                            ...
                            <div class="col-sm-3">
                             <textarea  id="address" name="address" cols="20" rows="3" class="form-control" required>
                             </textarea>
                            </div>
                          </div>
                          <div class="form-group ">
                            ...
                            <tbody>
                            	<c:forEach items="${splist}" var="list">
                            		<tr>
										...
										<td>
											<a data-toggle="modal"
											data-editspid="${list.id}"
											href="#myModal" class="btn btn-info btn-xs editSP"><li class="fa fa-edit"></li></a>                
										</td>
	                                </tr>
								</c:forEach>
                            </table>
    ...
    <%@include file="_Footer.jsp"%>
     <%@include file="modal/_ServiceProvider.jsp"%>
