...
<head>
<meta charset="utf-8">
<title>Data-Builder-Department</title>
...
<body class=" ">
	...
	<div id="page-container">
											...
											<tbody>
												<c:forEach items="${deptlist}" var="dept">
													<tr>
														...
														<c:when test="${dept.status == 'Pending'}">
														...
														<td><a data-toggle="modal"
															data-editdeptid="${dept.departmentid}"
															href="#myModal" class="btn btn-info btn-xs editDept">
		...
		<%@include file="modal/_Department.jsp"%>
	</div>
	<!-- page-container -->
	...
	<script type='text/javascript'
		src='assets/plugins/easypiechart/jquery.easypiechart.min.js'></script>
	<script type='text/javascript'
