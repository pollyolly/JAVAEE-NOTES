			...
			<div class="panel panel-primary">
				...
				<div class="panel-body collapse in">
					<form class="form-horizontal" action="Import" method="POST" enctype="multipart/form-data">
						<input type="hidden" name="forms" id="forms" value="import"/>
							<div class="col-sm-2"></div>
							<div class="col-sm-8">
								<div class="fileinput fileinput-new" data-provides="fileinput"><input name="forms" value="" type="hidden" value="CashAdvance">
