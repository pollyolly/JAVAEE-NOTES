...
<head>
    <meta charset="utf-8">
    <title>Report-Travel Expense</title>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body collapse in">
                           <div class="table-responsive">
                            ...
                            <tbody>
                             <c:forEach items="${travelexpensereport}" var="list">
                                    <tr>
                                        <td>${list.tono}</td>
                                        <td>${list.name}</td>
                                        <td>${list.fromdate}</td>
										...
										<td><fmt:formatNumber value="${list.total}" type="currency" currencySymbol="P" minFractionDigits="2"/></td>
                                        <td>
                                        	<c:choose>
                                        ...
                                        <td><a href="_ReportTravelExpense?odid=${list.id}" class="btn btn-default btn-xs" target="_blank">Preview</a></td>
                                    </tr>
                             </c:forEach>
                            </tbody>
                            </table>
