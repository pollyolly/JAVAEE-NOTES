		...
		<div class="modal-content">
			<div class="panel panel-primary">
                    ...
                    <div class="panel-body collapse in">
                        ...
                        <input type="hidden" class="form-control" id="forms" name="forms" value="updateExpenseCategory">
                        <input type="hidden" class="form-control" id="expensecatid" name="expensecatid">
                          <div class="form-group ">
                            <label for="focusedinput" class="col-sm-4 control-label">Name:</label>
                            <div class="col-sm-6">
                              <input type="text" class="form-control" id="name2" name="name2" placeholder="Department">
                            </div>
                          </div>
                          <div class="form-group">
                            <label for="focusedinput" class="col-sm-4 control-label">Department:</label>
                            <div class="col-sm-6">
                            <select id="department2" name="department2" style="width:100%" class="select2">
                                <option></option>
                          ...
                          <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                              <div class="input-group">
								<input class="form-control" type="number" id="rate2" name="rate2">
