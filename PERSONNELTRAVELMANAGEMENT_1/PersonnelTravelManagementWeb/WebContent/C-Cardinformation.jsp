...
<head>
	<meta charset="utf-8">
	<title>Configuration Management-Card Information</title>
...
<!--BEGIN ADD FORM-->
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body collapse in">
                        ...
                        <input type="hidden" id="forms"  name="forms"  value="addCardinformation">
					<div class="form-group ">
					<label for="focusedinput" class="col-sm-2 control-label">Card#:</label>
                            <div class="col-sm-3">
                              <input type="text" class="form-control" id="cardnumber"  name="cardnumber" maxlength="8" placeholder="00000000">
                            </div>
                          </div>
					<div class="form-group ">
						<label for="focusedinput" class="col-sm-2 control-label">ExpirationDate:</label>
                            <div class="col-sm-3">
                                    <div class="input-group date datepicker2">
                                        <input type="text" id="expirydate" name="expirydate" class="form-control" placeholder="yyyy-mm-dd">
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                    </div>
                                </div>
                          </div>
					<div class="form-group ">
                            <label for="mediuminput" class="col-sm-2 control-label">CardType:</label>
                            <div class="col-sm-3">
					...
					<div class="form-group ">
                            <label for="mediuminput" class="col-sm-2 control-label">Ownership:</label>
                            <div class="col-sm-3">
					...
					<div class="form-group">
                            ...
                            <div class="col-sm-3">
                            <select name="employee" id="employee" style="width:100%;" class="select2">
                                <option></option>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body collapse in">
                           <div class="table-responsive">
                            ...
                            <tbody>
                             <c:forEach items="${Cardinfolist}" var="list">
                                <tr>
								...
								<td>
									<a href="#myModal" data-toggle="modal" data-editcardinfo="${list.cardid}" class="btn btn-info btn-xs editCard"><li class="fa fa-edit"></li></a>                 
								</td>
                                    </tr>
                             </c:forEach>
                            </tbody>
    ...
    <%@include file="modal/_CardInformation.jsp"%>
