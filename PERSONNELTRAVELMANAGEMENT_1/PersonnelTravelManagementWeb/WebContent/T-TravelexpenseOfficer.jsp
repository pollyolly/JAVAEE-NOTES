...
<div id="page-content">
	<div id='wrap'>
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#" class="btn btn-success margBelow approveTE" data-status="7"><i class="glyphicon glyphicon-check"></i> Approve</a>
				<a href="#" class="btn btn-danger margBelow margLeft cancelTE" data-status="8"><i class="glyphicon glyphicon-remove-circle"></i> Not Approve</a>
                        ...
                        <div class="panel-body collapse in">
                           <div class="table-responsive">
                            ...
                            <c:forEach items="${explist}" var="list">
	                            <tr>
	                            	<td><a href="TravelExpenseListOfficer?odid=${list.id}" target="_blank">${list.name}</a></td>
	                            	<td>${list.tono}</td>
	                            	<td>${list.fromdate}</td>
	                            	<td>${list.todate}</td>
	                            	<td>
	...
	<%@include file="modal/_TravelExpenseComment.jsp"%>
</div> <!-- page-container -->
...
<script type='text/javascript' src='assets/js/TE_Status.js'></script>
