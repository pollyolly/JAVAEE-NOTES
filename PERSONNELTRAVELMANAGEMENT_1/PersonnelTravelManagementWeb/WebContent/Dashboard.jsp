                            ...
                            <a class="info-tiles tiles-success" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center">
                                    	<c:out value="${ToApprove[0].toapprove}" />
                                    </div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-alizarin" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center">
                                    	<c:out value="${ToCancel[0].tocancel}" />
                                    </div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-toyo" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    ...
                                    <div class="text-center">
										<c:out value="${Plan[0].plan}" />
                                    </div>
                                    <small>Total Travel Plan</small>
                                </div>
                        ...
                        <div class="col-md-3 col-xs-12 col-sm-6">
                            <a class="info-tiles tiles-orange" href="#">
                                ...
                                <div class="tiles-body-alt">
                                    <i class="fa fa-usd"></i>
							<div class="text-center">
								<c:out value="${Expense[0].expense}" />
							</div>
                                    <small>Total Travel Expense</small>
                                </div>
