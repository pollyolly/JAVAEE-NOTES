            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body collapse in">
                        <form class="form-horizontal" action="TravelPlan" method="POST">
                        <input type="hidden" name="forms" id="forms" value="addPlan">
                         <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">TravelOrder#:</label>
                            <div class="col-sm-3">
                            <select id="tno" name="tno" style="width:100%" class="select2" required>
                                <option></option>
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input id="food" name="food" class="form-control" type="text" placeholder="0">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input class="form-control" type="text" id="allowance" name="allowance" placeholder="0">
								<span class="input-group-addon">.00</span>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input class="form-control" type="text" id="accommodation" name="accommodation" placeholder="0">
								<span class="input-group-addon">.00</span>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-3">
							<div class="input-group">
								<input class="form-control" type="text" id="transportation" name="transportation" placeholder="0">
								<span class="input-group-addon">.00</span>
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">PerDiem:</label>
						<div class="col-sm-3">
							<div class="input-group">
								<input class="form-control" type="text" id="perdiem" name="perdiem" placeholder="0">
								<span class="input-group-addon">.00</span>
							</div>
						</div>
					</div>
                        ...
                        <div class="panel-body collapse in">
                           <div class="table-responsive">
                            ...
                            <c:forEach items="${planlist}" var="list">
	                            <tr>
	                            	<td><a href="TravelPlanList?tno=${list.tono}&tpid=${list.id}" target="_blank">${list.tono}</a></td>
	                            	<td>${list.fromdate}</td>
	                            	<td>${list.todate}</td>
