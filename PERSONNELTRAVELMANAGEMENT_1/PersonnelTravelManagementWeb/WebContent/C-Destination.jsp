...
<head>
<meta charset="utf-8">
<title>Configuration Management-Destination</title>
...
<body class=" ">
	...
	<div id="page-container">
										...
										<div class="form-group ">
											...
											<div class="col-sm-3">
												<input type="text" class="form-control" name="city"
													id="city" placeholder="Name" required>
											</div>
										</div>
										<div class="form-group ">
											...
											<div class="col-sm-3">
												<input type="text" class="form-control" name="state"
													id="state" placeholder="Name" required>
											</div>
										</div>
										<div class="form-group ">
											...
											<div class="col-sm-3">
												<input type="text" class="form-control" name="country"
													id="country" placeholder="Name" required>
											</div>
										</div>
										<div class="form-group ">
								...
								<div class="panel-body collapse in">
									<div class="table-responsive">
										<table
											...
											<tbody>
												<c:forEach items="${destlist}" var="list">
													<tr>
														<td>${list.code}</td>
														<td>${list.city}</td>
														<td>${list.state}</td>
														...
														<td><a data-toggle="modal" data-editdestid="${list.id}" href="#myModal" class="btn btn-info btn-xs editDestination">
		...
		<%@include file="modal/_Destination.jsp"%>
	</div>
	<!-- page-container -->
