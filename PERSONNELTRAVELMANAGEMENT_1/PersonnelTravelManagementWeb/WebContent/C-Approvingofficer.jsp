...
<head>
<meta charset="utf-8">
<title>Configuration-Approving Officer</title>
...
<body class=" ">
	...
	<div id="page-container">
						...
						<div class="col-md-12">
							<div class="panel panel-primary">
								...
								<div class="panel-body collapse in">
									<form class="form-horizontal" action="ApprovingOfficer" method="POST">
									<input type="hidden" class="form-control" name="forms"
											id="forms" value="addApprovingOfficer" />
										
										<div class="form-group ">
											<label for="focusedinput" class="col-sm-2 control-label">Employee:</label>
											<div class="col-sm-3">
												<select id="employee" name="employee" style="width: 100%" class="select2">
													<option></option>
											...
											<tbody>
												<c:forEach items="${alllist}" var="list">
													<tr>
														...
														<td><a  data-toggle="modal" data-editappid="${list.officerid}" href="#myModal" class="btn btn-info btn-xs editApprov">
		...
		<%@include file="modal/_Approvingofficer.jsp"%>
	</div>
	<!-- page-container -->
