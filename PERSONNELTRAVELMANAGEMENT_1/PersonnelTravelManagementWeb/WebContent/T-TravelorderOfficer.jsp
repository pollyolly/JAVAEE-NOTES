...
<!--BEGIN ADD FORM-->
		...
		<div class="row">
			<div class="col-md-12">
				<a href="#" class="btn btn-success margBelow approveTO" data-status='7'>
				<i class="glyphicon glyphicon-check"></i> Approve</a>
				<a href="#" class="btn btn-danger margBelow margLeft cancelTO" data-status='8'>
				<!-- i class="glyphicon glyphicon-remove-circle"></i--> Not Approve</a>
			</div>
		</div>
		<div class="row">
              <div class="col-md-12">
                           ...
                           <div class="table-responsive">
                            ...
                            <c:forEach items="${travelorderlist}" var="list">
                                <tr>
                                        ...
                                        <td>
                                        <c:choose>
										<c:when test="${list.priority == 'Medium'}">
											<span class="label label-success">Medium</span>
										</c:when>
										<c:when test="${list.priority== 'Low'}">
    ...
    <%@include file="modal/_TravelOrderComment.jsp"%>
...
<script type='text/javascript' src='assets/js/TO_Status.js'></script>
