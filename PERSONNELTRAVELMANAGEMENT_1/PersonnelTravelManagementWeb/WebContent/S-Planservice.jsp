...
<head>
	<meta charset="utf-8">
	<title>DataBuilder-Plan Service</title>
                    ...
                    <div class="panel-body collapse in">
                        <form class="form-horizontal">
                          <div class="form-group ">
                            <label for="focusedinput" class="col-xs-2 control-label">Name:</label>
                            <div class="col-xs-3">
                              <input type="text" class="form-control" id="focusedinput" placeholder="Default Input">
                            </div>
                          </div>
                          <div class="form-group ">
                            <label for="focusedinput" class="col-xs-2 control-label">Description:</label>
                            <div class="col-xs-3">
                              <input type="text" class="form-control" id="focusedinput" placeholder="Default Input">
                            </div>
                          </div>
                          <div class="form-group ">
                            <label for="mediuminput" class="col-xs-2 control-label">Status:</label>
                            <div class="col-xs-3">
