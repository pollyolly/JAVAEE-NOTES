...
/**
 * Servlet implementation class _ReportTravelBudget
 */
@WebServlet("/_ReportTravelBudget")
public class _ReportTravelBudget extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private Connection conn = null;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public _ReportTravelBudget() {
    	try {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String reportFile = getServletContext().getRealPath("_ReportTravelBudget.jrxml");
