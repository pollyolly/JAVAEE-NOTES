...
/**
 * Servlet implementation class TravelExpenseReportOfficer
 */
@WebServlet("/TravelExpenseReportOfficer")
public class TravelExpenseReportOfficer extends HttpServlet {
     ...
     */
    public TravelExpenseReportOfficer() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		rd = request.getRequestDispatcher("R-TravelexpenseOfficer.jsp");
