...
/**
 * Servlet implementation class TravelOrderReportPersonnel
 */
@WebServlet("/TravelOrderReportPersonnel")
public class TravelOrderReportPersonnel extends HttpServlet {
     ...
     */
    public TravelOrderReportPersonnel() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(list.size() > 0){
			...
			rd = request.getRequestDispatcher("R-TravelorderlistPersonnel.jsp");
